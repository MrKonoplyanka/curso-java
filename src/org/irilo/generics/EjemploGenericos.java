package org.irilo.generics;

import org.irilo.poointerfaces.modelo.Cliente;
import org.irilo.poointerfaces.modelo.ClientePremium;
...
public class EjemploGenericos {
    public static void main(String[] args) {
        ...
        Cliente[] clientesArray = {new Cliente("Andrés","Guzmán"),new Cliente("Luci","Martínez")};
        ...
        List<String> nombres = fromArrayToList(new String[]{"Andrés", "Pepe", "Luci", "Bea", "John"},enterosArray);
