        ...
        <div class="col-sm-4">
            <select name="lenguajes" id="lenguajes" multiple class="form-select">
                ...
                <option value="jakartaee"
                 ${paramValues.lenguajes.stream().anyMatch(v->v.equals("java")).get()?"selected":""}>Jakarta EE9</option>
                <option value="spring"
                 ${paramValues.lenguajes.stream().anyMatch(v->v.equals("spring")).get()?"selected":""}>Spring Boot</option>
                <option value="javascript"
                 ${paramValues.lenguajes.stream().anyMatch(v->v.equals("javascript")).get()?"selected":""}>JavaScript</option>
